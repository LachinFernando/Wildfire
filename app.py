...
def images(eval_data):
    ...
    for i, row in eval_data.iterrows():
        ...
        if PF == 1:
            prev_mask_grid[row_number,column_index] = [255,0,0]
        elif PF == 0:
            prev_mask_grid[row_number,column_index] = [150, 146, 146]
        elif PF == -1:
            prev_mask_grid[row_number,column_index] = [0,0,0]
...
#set the image
st.image("assets/wildfire.jpeg", caption = "Wildfire Preventing")
